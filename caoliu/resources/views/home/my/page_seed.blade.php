            ...
            <div class="col-md-10" style="background-color:#F1F1F1;">
                <div class="page-content-wrapper" style="height:965px; ">
                    ...
                    <div class="p1age-content" >
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h3 class="page-title"> <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-persona tooltips" data-original-title="Persona"></a>填写物流单号
                            <small></small>
                        </h3>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                                    ...
                                    <div class="portlet-body">
                                        <div class="tabbable-line">
                                            <div class="tab-content">
                                                ...
                                                <form action="{{url('home/goods/seed')}}" method="post">
            
                                                    {{csrf_field()}}
                                                    物流单号:<input type="number" name="orders_number" value="" ><br/></br>
                                                    <input type="hidden" name="goods_id" value="{{$items->goods_id}}"/>
                                                    <input type="hidden" name="goods_status" value="{{$items->goods_status}}"/>
