            ...
            <div class="col-md-10" style="background-color:#F1F1F1;">
                <div class="page-content-wrapper" style="height:965px; ">
                    ...
                    <div class="p1age-content" >
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h3 class="page-title"> <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-persona tooltips" data-original-title="Persona"></a>我的订单
                            <small></small>
                        </h3>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                                        ...
                                        <div class="tabbable-line">
                                            <ul class="nav nav-tabs nav-tabs-lg">
                                                <li class="active bold">
                                                    <a href="#tab_1" data-toggle="tab" aria-expanded="true"><font><font> 所有订单</font></font></a>
                                                </li>
                                                <li class="bold">
                                                    <a href="#tab_2" data-toggle="tab" aria-expanded="false"><font><font>待付款
                                                            </font></font><span class="badge badge-success"><font><font>4</font></font></span>
                                                    </a>
                                                </li>
                                                <li class="bold">
                                                    <a href="#tab_3" data-toggle="tab" aria-expanded="false"><font><font> 代发货 </font></font></a>
                                                </li>
                                                <li class="bold">
                                                    <a href="#tab_4" data-toggle="tab" aria-expanded="false"><font><font>待收货
                                                            </font></font><span class="badge badge-danger"><font><font>2</font></font></span>
                                                    </a>
                                                </li>
                                                <li class="bold">
                                                    <a href="#tab_5" data-toggle="tab" aria-expanded="false"><font><font> 待评价 </font></font></a>
                                                </li>
                                                <li class="bold">
                                                    <a href="#tab_6" data-toggle="tab" aria-expanded="false"><font><font> 订单操作* </font></font></a>
                                                </li>
                                            </ul>
                                                                ...
                                                                <div class="portlet-body" style="padding:0px;">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-hover table-bordered table-striped" style="margin:0px;">
                                                                            <thead>
                                                                            <tr>
                                                                                <th style="padding:0px; width:200px; height:100px;"><div class="fileinput-new thumbnail" style="width: 150px; height: 100px; margin:3px; padding:0px;">
                                                                                        <img src="http://www.placehold.it/150x100/EFEFEF/AAAAAA&amp;text=no+image" alt=""> </div></th>
                                                                                <th style="width:270px;  line-height: 100px;"><a>这是显示的是商品的名称啊啊啊啊啊啊啊</a></th>
                                                                                <th style="width:170px;  line-height: 100px;">¥30000</th>
                                                                                <th style="width:170px;  line-height: 100px;">1000</th>
                                                                                <td   style="width:100px;">
                                                                                    <a href="javascript:;"   style="margin-top:30px;"    class="btn dark btn-sm btn-outline sbold uppercase">
                                                                                        <i class="fa fa-share" ></i><font><font> 联系对方 </font></font></a>
                                                                                </td>
                                                                                <td   style="width:100px;">
                                                                                    <a href="javascript:;"   style="margin-top:30px;"    class="btn dark btn-sm btn-outline sbold uppercase">
                                                                                        <i class="fa fa-share" ></i><font><font> 订单详情 </font></font></a>
                                                                                </td>
                                                                            </tr>
                                                                            </thead>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover table-bordered table-striped" style="margin:0px;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td   style="width:100px;">
                                                                                <a href="javascript:;"   style="margin-top:30px;"    class="btn dark btn-sm btn-outline sbold uppercase">
                                                                                    <i class="fa fa-share" ></i><font><font> 立即付款</font></font></a>
                                                                            </td>
                                                                        </tr>
                                                                        </thead>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover table-bordered table-striped" style="margin:0px;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td   style="width:100px;">
                                                                                <a href="javascript:;"   style="margin-top:30px;"    class="btn dark btn-sm btn-outline sbold uppercase">
                                                                                    <i class="fa fa-share" ></i><font><font> 立即发货</font></font></a>
                                                                            </td>
                                                                        </tr>
                                                                        </thead>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover table-bordered table-striped" style="margin:0px;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td   style="width:100px;">
                                                                                <a href="javascript:;"   style="margin-top:10px;"    class="btn dark btn-sm btn-outline sbold uppercase">
                                                                                    <i class="fa fa-share" ></i><font><font> 订单详情 </font></font></a>
                                                                                <a href="javascript:;"   style="margin-top:10px;"    class="btn dark btn-sm btn-outline sbold uppercase">
                                                                                    <i class="fa fa-share" ></i><font><font> 查看物流 </font></font></a>
                                                                            </td>
                                                                            <td   style="width:100px;">
                                                                                <a href="javascript:;"   style="margin-top:30px;"    class="btn dark btn-sm btn-outline sbold uppercase">
                                                                                    <i class="fa fa-share" ></i><font><font> 确认收货</font></font></a>
                                                                            </td>
                                                                        </tr>
                                                                        </thead>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover table-bordered table-striped" style="margin:0px;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td   style="width:100px;">
                                                                                <a href="javascript:;"   style="margin-top:30px;"  data-toggle="modal" data-target="#myModal"   class="btn dark btn-sm btn-outline sbold uppercase">
                                                                                    <i class="fa fa-share "  ></i><font><font> 订单详情 </font></font></a>
                                                                            </td>
                                                                            <td   style="width:100px;">
                                                                                <a href="javascript:;"   style="margin-top:30px;"    class="btn dark btn-sm btn-outline sbold uppercase">
                                                                                    <i class="fa fa-share" ></i><font><font> 立即评价</font></font></a>
                                                                            </td>
                                                                        </tr>
                                                                        </thead>
