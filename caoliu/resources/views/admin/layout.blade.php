...
<head>
    ...
    <!-- Morris chart -->
    <link rel="stylesheet" href="{{ asset('/admin_template/bower_components/morris.js/morris.css') }}">
    <!-- jvectormap -->
    ...
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{ asset('/admin_template/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>草榴</b></span>
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{ asset('/admin_template/dist/img/user3-128x128.jpg') }}" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{ asset('/admin_template/dist/img/user4-128x128.jpg') }}" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    @endif
                                     - @if(session()->get('user_level')==0)
                                            无敌的管理员
                                        @elseif(!empty(session()->get('user_level')) && session()->get('user_level')==1)
                                            @if(!empty(session()->get('user_status')) && session()->get('user_status')==1)
                                                商品管理员
                                            @elseif(!empty(session()->get('user_status')) && session()->get('user_status')==2)
                                                订单管理员
                                            @elseif(!empty(session()->get('user_status')) && session()->get('user_status')==3)
                                                用户管理员
                                            @endif
                                        @endif
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{url('/admin/pass')}}" class="btn btn-default btn-flat">修改密码</a>
                                </div>
                                <div class="pull-right">
                                    <a href="{{ url('/admin/loginout') }}" class="btn btn-default btn-flat">退出</a>
                                </div>
                            </li>
                        </ul>
                    </li>
          ...
          <span class="input-group-btn">
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="{{url('admin/user/create')}}"><i class="fa fa-circle-o"></i> 管理员添加</a></li>
                        <li><a href="{{url('admin/user')}}"><i class="fa fa-circle-o"></i> 管理员列表</a></li>
                    </ul>
                    @endif
                </li>
                <li class="treeview">
            ...
            <span class="pull-right-container">
              {{--<span class="label label-primary pull-right">4</span>--}}
                    ...
                    @if(session()->get('user_level')==1 || session()->get('user_level')==0)
                    <ul class="treeview-menu">
                        <li><a href="{{url('admin/goodsType/create')}}"><i class="fa fa-circle-o"></i>添加分类</a></li>
                        <li><a href="{{url('admin/goodsType')}}"><i class="fa fa-circle-o"></i>分类列表</a></li>
                        <li><a href="{{url('admin/goods')}}"><i class="fa fa-circle-o"></i>商品管理</a></li>
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    @if(session()->get('user_level')==2 || session()->get('user_level')==0)
                    <ul class="treeview-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    @if(session()->get('user_level')==3 || session()->get('user_level')==0)
                        <ul class="treeview-menu">
                            <li><a href="{{url('admin/homeuser')}}"><i class="fa fa-circle-o"></i> 用户列表</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    @if(session()->get('user_level')==3 || session()->get('user_level')==0)
                        <ul class="treeview-menu">
                            <li><a href="{{url('admin/homeweb')}}"><i class="fa fa-circle-o"></i> 轮播图管理</a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-edit"></i> <span>金库</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    @if(session()->get('user_level')==0)
                    <ul class="treeview-menu">
                        <li><a href=""><i class="fa fa-circle-o"></i>查看金库</a></li>
...
<!-- jQuery UI 1.11.4 -->
<script src="{{ asset('/admin_template/bower_components/jquery-ui/jquery-ui.min.js') }}"></script>
...
<!-- Morris.js charts -->
<script src="{{ asset('/admin_template/bower_components/raphael/raphael.min.js') }}"></script>
<script src="{{ asset('/admin_template/bower_components/morris.js/morris.min.js') }}"></script>
<!-- Sparkline -->
...
<!-- jQuery Knob Chart -->
<script src="{{ asset('/admin_template/bower_components/jquery-knob/dist/jquery.knob.min.js') }}"></script>
<!-- daterangepicker -->
<script src="{{ asset('/admin_template/bower_components/moment/min/moment.min.js') }}"></script>
<script src="{{ asset('/admin_template/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<!-- datepicker -->
